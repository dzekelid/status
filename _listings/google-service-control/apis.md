...
created: "2018-02-26"
modified: "2018-02-26"
url: https://raw.githubusercontent.com/streamdata-gallery/status/master/_listings/google-service-control/apis.yaml
...
- name: Google Service Control API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/status/master/_listings/google-service-control/v1-services-servicename-startreconciliation-post.md
x-common:
- type: x-change-log
